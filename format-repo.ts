...
const V3_CORE_PACKAGE = '@birthdayresearchforks/uniswap-v3-core'
const V3_CORE_PACKAGE_TO_REPLACE = '@birthdayresearch/uniswap-v3-core'
...
function handleSolidityFile(filePath: string) {
  ...
  for (let i = 0; i < fileLines.length; i++) {
    ...
    if (line.includes(V3_CORE_PACKAGE_TO_REPLACE)) {
      fileLinesCopy[i] = line.replace(V3_CORE_PACKAGE_TO_REPLACE, V3_CORE_PACKAGE)
      changeMade = true
    }
